...
function BlogPostCard({ blogpost }) {
    ...
    const defaultCopyText = 'Copiar URL'
...
function Search(props) {
    ...
    {/* the GET query parameter in https://carlosloureda.com/blog/?q=test */ }
    return (
        <div>
            <div css={{ maxWidth: 500, margin: 'auto' }}>
                ...
                {/* <small css={{ marginTop: 10, display: 'block' }}>
                    ...
                    <a href="https://www.google.com/search?q=site%3Acarlosloureda.com%2Fblog+testing">
                        using Google
          </a>
                    {'.'}
                </small> */}
